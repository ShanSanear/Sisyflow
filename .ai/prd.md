...
-   Każdy ticket składa się z następujących pól:
    ...
    -   Załączniki (pliki .txt i .md, limit 1 MB na plik).
    -   Osoba zgłaszająca (ustawiana automatycznie).
    -   Osoba przypisana.
    -   Komentarze (obsługują formatowanie Markdown).
...
-   System generuje dwa typy sugestii:
    -   *Sugestie do wstawienia*: Konkretne fragmenty tekstu z przyciskiem "Dodaj", który wstawia je do opisu.
    -   *Pytania otwarte*: Pytania kontrolne z checkboxem "Zastosowano", który użytkownik może zaznaczyć.
...
-   Kryteria akceptacji:
    ...
    2.  Mogę modyfikować tytuł, opis, typ, załączniki i osobę przypisaną.
...
### 5.5. Komentarze i załączniki

-   ID: US-014
-   Tytuł: Dodawanie komentarza do ticketa
-   Opis: Jako użytkownik, chcę móc dodać komentarz do dowolnego ticketa, aby zadać pytanie lub podzielić się dodatkowymi informacjami.
-   Kryteria akceptacji:
    1.  W widoku szczegółów ticketa znajduje się pole do wpisania nowego komentarza.
    2.  Pole komentarza obsługuje formatowanie Markdown.
    3.  Po dodaniu, mój komentarz jest widoczny na liście komentarzy wraz z moją nazwą użytkownika i datą.

-   ID: US-015
-   Tytuł: Edycja i usuwanie własnego komentarza
-   Opis: Jako autor komentarza, chcę móc go edytować lub usunąć, aby poprawić literówkę lub wycofać nieaktualną informację.
-   Kryteria akceptacji:
    1.  Przy moich własnych komentarzach widoczne są opcje "Edytuj" i "Usuń".
    2.  Mogę edytować treść komentarza bez ograniczeń czasowych.
    3.  Mogę trwale usunąć swój komentarz po potwierdzeniu.
    4.  Administrator może usunąć dowolny komentarz, ale nie może edytować komentarzy innych użytkowników.

-   ID: US-016
-   Tytuł: Dodawanie załączników do ticketa
-   Opis: Jako użytkownik tworzący lub edytujący ticket, chcę móc dołączyć pliki .txt lub .md, aby dostarczyć logi, fragmenty kodu lub dodatkową dokumentację.
-   Kryteria akceptacji:
    1.  W formularzu ticketa znajduje się opcja dodawania załączników.
    2.  System akceptuje tylko pliki z rozszerzeniem .txt i .md.
    3.  Maksymalny rozmiar pojedynczego pliku to 1 MB.
    4.  Po dodaniu, załączniki są widoczne w widoku szczegółów ticketa jako lista linków do pobrania.
