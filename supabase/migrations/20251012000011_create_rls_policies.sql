...
-- affected: rls policies for all tables (profiles, tickets, comments, attachments, ai_suggestion_sessions, project_documentation, ai_errors)
...
-- rls policy: allow all authenticated users to view comments
-- rationale: comments are part of ticket discussion and should be visible to all team members
...
-- rls policy: allow all authenticated users to create comments
-- rationale: any user should be able to participate in ticket discussions
...
-- rls policy: allow authors to update their own comments
-- rationale: users should be able to fix typos or clarify their comments
...
-- rls policy: allow admins to delete any comment
-- rationale: admins need to remove inappropriate or spam comments
...
-- rls policy: allow authors to delete their own comments
-- rationale: users should be able to remove their own comments if needed
...
-- rls policy: allow all authenticated users to view attachments
-- rationale: attachments are part of ticket content and should be accessible to all team members
...
-- rls policy: allow all authenticated users to create attachments
-- rationale: any user should be able to add supporting documentation to tickets
...
-- note: no update policy - attachments are immutable once created
-- rationale: attachments should not be modified to maintain data integrity and history

-- rls policy: allow admins to delete any attachment
-- rationale: admins need to remove inappropriate files or manage storage
...
-- rls policy: allow ticket reporters to delete attachments from their tickets
-- rationale: ticket creators should be able to manage files on their own tickets
create policy "attachments_delete_reporter"
  on public.attachments
  for delete
  to authenticated
  using (
